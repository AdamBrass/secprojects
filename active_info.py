...
# using sys.argv[1] as IP address
# sys.argv[2] as port
# will need to change other variables depending on TCP or UDP port
#/usr/bin/python3
import nmap
import sys
import time
...
nm_scanner = nm_scan.scan(sys.argv[1], sys.argv[2], arguments = '-O')

host_is_up = "The host is: " + nm_scanner['scan'][sys.argv[1]]['status']['state'] + ".\n"
port_open = "The port  is: " + nm_scanner['scan'][sys.argv[1]]['tcp'][sys.argv[2]]['state'] + ".\n"
method_scan = "The method of scanning is: " + nm_scanner['scan'][sys.argv[1]]['tcp'][sys.argv[2]['reason'] + ".\n"
